...
class _SOLVERWRAPPER_CPLEX
{
	...
	int solve()
	{
		...
		if (s.in.hasIntegerVariables)
		{
			...
			if (!s.out.solutionIsFeasible) throw new JOMException("JOM - CPLEX interface. The problem could not be solved. CPLEX error message: " + s.out.statusMessage);
