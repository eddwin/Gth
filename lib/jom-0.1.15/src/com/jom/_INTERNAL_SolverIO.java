...
class _INTERNAL_SolverIO
{
	...
	{
		String s = "";
		s += "** SOLVER IO: outputSolutionSet: " + outputSolutionSet + "\n";
		s += "     INPUT STRUCT -----\n";
...
//			s += DoubleFactory2D.dense.make(coefs.toArray()) + "\n";
	...
	void checkFeasibility ()
	{
		...
		if (!outputSolutionSet) throw new JOMException ("The problem has not been solved");
