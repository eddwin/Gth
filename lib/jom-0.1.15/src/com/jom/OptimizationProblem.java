...
public class OptimizationProblem 
{
	 ...
	 * @return See above
	 */
	public boolean feasibleSolutionDoesNotExist () { if (!this.solverIO.outputSolutionSet) throw new JOMException("The problem has not been solved yet"); else return this.solverIO.out.feasibleSolutionDoesNotExist; }
	 ...
	 * @return See above
	 */
	public boolean foundUnboundedSolution () { if (!this.solverIO.outputSolutionSet) throw new JOMException("The problem has not been solved yet"); else return this.solverIO.out.foundUnboundedSolution; }
	 ...
	 * @return See above
	 */
	public boolean solutionIsFeasible () { if (!this.solverIO.outputSolutionSet) throw new JOMException("The problem has not been solved yet"); else return this.solverIO.out.solutionIsFeasible; }
	 ...
	 * @return See above
	 */
	public boolean solutionIsOptimal () { if (!this.solverIO.outputSolutionSet) throw new JOMException("The problem has not been solved yet"); else return this.solverIO.out.solutionIsOptimal; }
	...
	public String toString ()
	{
		...
		s = s + "----------- SOLUTION: \n";
		if (!solverIO.outputSolutionSet) { s = s + " -- NOT SOLVED YET --"; return s; }
	...
	private HashMap<String,Object> createParametersMapInitilizingDefaults (String solverName , Object [] paramValuePairs , _INTERNAL_SolverIO solverIO)
	{
		...
		if (!params.containsKey("solverLibraryName"))
			if (solverName.equalsIgnoreCase("glpk"))
			{
				...
				if (os.startsWith("Windows") && arch.contains("64")) params.put("solverLibraryName", "glpk_4_48"); // win64
				else if (os.startsWith("Windows") && !arch.contains("64")) params.put("solverLibraryName", "glpk_4_48"); // win32
			...
			else if (solverName.equalsIgnoreCase("ipopt"))
			{
				String os = System.getProperty("os.name");
				String arch = System.getProperty("os.arch");
				if (os.startsWith("Windows") && arch.contains("64")) params.put("solverLibraryName", "Ipopt38"); // win64
				else if (os.startsWith("Windows") && !arch.contains("64")) params.put("solverLibraryName", "Ipopt38"); // win32
			...
			else if (solverName.equalsIgnoreCase("cplex"))
			{
				String os = System.getProperty("os.name");
				String arch = System.getProperty("os.arch");
				if (os.startsWith("Windows") && arch.contains("64")) params.put("solverLibraryName", "cplex"); // win64
				else if (os.startsWith("Windows") && !arch.contains("64")) params.put("solverLibraryName", "cplex"); // win32
		...
		Double val_maxSolverTimeInSeconds = (Double) params.get("maxSolverTimeInSeconds");
