...
class IntMatrixND
{
	...
	public static IntMatrix2D ind2sub(IntMatrix1D indexes, IntMatrix1D size)
	{
		...
		if (indexes.getMaxLocation()[0] > numCells - 1) { throw new RuntimeException("Index out of bounds in n-dim array"); }
		if (indexes.getMinLocation()[0] < 0) { throw new RuntimeException("Index out of bounds in n-dim array"); }
